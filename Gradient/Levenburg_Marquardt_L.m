function [Err_s,Err_f,extr_cur,wand_dis,x_cur,itr]=Levenburg_Marquardt_L(weight,im_coordinate,extr_cur,focal_len,P_point,x_cur,M,N,marker_dis,itr_max,th)
