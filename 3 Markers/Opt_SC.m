function [Err_s,Err_f,extr_cur,wand_dis,x_cur,time]=Opt_SC(weight,x_cur,im_coordinate,extr_cur,P_point,focal_len,M,N_fp,N,marker_dis,itr_max,th)
...
beta=1;
tic
while (big_iteration<itr_max && max(abs(P2-P1))>th)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%% Optimizatio loop %%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        m=1;
        while (m<=M)
            Ea(1)=(-focal_len(n))*(extr_cur(n,5) + x_cur(2*m-1,2)*(cos(extr_cur(n,1))*cos(extr_cur(n,3)) - sin(extr_cur(n,1))*sin(extr_cur(n,2))*sin(extr_cur(n,3))) + x_cur(2*m-1,3)*(cos(extr_cur(n,3))*sin(extr_cur(n,1)) + cos(extr_cur(n,1))*sin(extr_cur(n,2))*sin(extr_cur(n,3))) - x_cur(2*m-1,1)*cos(extr_cur(n,2))*sin(extr_cur(n,3))) - (im_coordinate(1,1,m,n) - P_point(1,n))*(extr_cur(n,6) + x_cur(2*m-1,1)*sin(extr_cur(n,2)) + x_cur(2*m-1,3)*cos(extr_cur(n,1))*cos(extr_cur(n,2)) - x_cur(2*m-1,2)*cos(extr_cur(n,2))*sin(extr_cur(n,1)));
            Ea(2)=(P_point(2,n) - im_coordinate(1,2,m,n))*(extr_cur(n,6) + x_cur(2*m-1,1)*sin(extr_cur(n,2)) + x_cur(2*m-1,3)*cos(extr_cur(n,1))*cos(extr_cur(n,2)) - x_cur(2*m-1,2)*cos(extr_cur(n,2))*sin(extr_cur(n,1))) - (-focal_len(n))*(extr_cur(n,4) + x_cur(2*m-1,2)*(cos(extr_cur(n,1))*sin(extr_cur(n,3)) + cos(extr_cur(n,3))*sin(extr_cur(n,1))*sin(extr_cur(n,2))) + x_cur(2*m-1,3)*(sin(extr_cur(n,1))*sin(extr_cur(n,3)) - cos(extr_cur(n,1))*cos(extr_cur(n,3))*sin(extr_cur(n,2))) + x_cur(2*m-1,1)*cos(extr_cur(n,2))*cos(extr_cur(n,3)));
            Ea(3)=(-focal_len(n))*(extr_cur(n,5) + x_cur(2*m,2)*(cos(extr_cur(n,1))*cos(extr_cur(n,3)) - sin(extr_cur(n,1))*sin(extr_cur(n,2))*sin(extr_cur(n,3))) + x_cur(2*m,3)*(cos(extr_cur(n,3))*sin(extr_cur(n,1)) + cos(extr_cur(n,1))*sin(extr_cur(n,2))*sin(extr_cur(n,3))) - x_cur(2*m,1)*cos(extr_cur(n,2))*sin(extr_cur(n,3))) - (im_coordinate(2,1,m,n) - P_point(1,n))*(extr_cur(n,6) + x_cur(2*m,1)*sin(extr_cur(n,2)) + x_cur(2*m,3)*cos(extr_cur(n,1))*cos(extr_cur(n,2)) - x_cur(2*m,2)*cos(extr_cur(n,2))*sin(extr_cur(n,1)));
            Ea(4)=(P_point(2,n) - im_coordinate(2,2,m,n))*(extr_cur(n,6) + x_cur(2*m,1)*sin(extr_cur(n,2)) + x_cur(2*m,3)*cos(extr_cur(n,1))*cos(extr_cur(n,2)) - x_cur(2*m,2)*cos(extr_cur(n,2))*sin(extr_cur(n,1))) - (-focal_len(n))*(extr_cur(n,4) + x_cur(2*m,2)*(cos(extr_cur(n,1))*sin(extr_cur(n,3)) + cos(extr_cur(n,3))*sin(extr_cur(n,1))*sin(extr_cur(n,2))) + x_cur(2*m,3)*(sin(extr_cur(n,1))*sin(extr_cur(n,3)) - cos(extr_cur(n,1))*cos(extr_cur(n,3))*sin(extr_cur(n,2))) + x_cur(2*m,1)*cos(extr_cur(n,2))*cos(extr_cur(n,3)));
            ...
            J_df=J_df-weight(m,n)*[J(1,1); J(1,2); J(1,3)]*Ea(1); % Addition to current J'*delta(f) vector
            ...
            H=H+weight(m,n)*(J'*J);
            J_df=J_df-[J(1,1); J(1,2); J(1,3)]*Ea(2)*weight(m,n);
            ...
            H=H+weight(m,n)*(J'*J);
            J_df=J_df-weight(m,n)*[J(1,1); J(1,2); J(1,3)]*Ea(3);
            ...
            H=H+weight(m,n)*(J'*J);
            J_df=J_df-weight(m,n)*[J(1,1); J(1,2); J(1,3)]*Ea(4);
            m=m+1;
        end
        
        %%%%%%%%%%% Addition of update to the current values %%%%%%%%%%
        extr_cur(n,1:3)=extr_cur(n,1:3)+(H\J_df)';
   end
